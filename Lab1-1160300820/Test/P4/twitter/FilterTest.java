...
public class FilterTest {
    ...
    private static final Instant d5 = Instant.parse("2016-02-17T08:30:00Z");
    
    private static final Tweet tweet1 = new Tweet(1, "alyssa", "is it reasonable to talk about rivest so much?", d1);
    private static final Tweet tweet2 = new Tweet(2, "bbitdiddle", "rivest talk in 30 minutes #hype", d2);
    private static final Tweet tweet3 = new Tweet(3, "alyssa", "rivest Talk in 30 min @paul utes #hype", d3);
    private static final Tweet tweet4 = new Tweet(4, "bbit", "rivest talk@hello #hype", d4);
    private static final Tweet tweet5 = new Tweet(5, "itdiddle", "rivest @pop tak in 30 minutes #hype", d5);
    ...
    public void testInTimespanMultipleTweetsMultipleResults() {
        ...
        List<Tweet> inTimespan = Filter.inTimespan(Arrays.asList(tweet1, tweet3,tweet4,tweet5,tweet2), new Timespan(testStart, testEnd));
